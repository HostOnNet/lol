...
<input type='checkbox' name='agreeterms' /> <span style='color: #fff;'>I confirm that I've read <a href='terms.html' class='big-link' data-reveal-id='myModal' data-animation='fade'>the terms of use</a></span>
<br />
<br />
